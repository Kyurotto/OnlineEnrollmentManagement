...
class RegistrarArchiveManager extends Component
{
    use WithPagination;
    ...
    public function togglePhysicalDocuments($id)
    {
        ...
        session()->flash('success', 'Physical documents status updated.');
    }
    ...
    public function verifyCredentials($id)
    {
        ...
        session()->flash('success', 'Credentials marked as verified.');
    }

    public function rejectCredentials($id)
    {
        $enrollment = Enrollment::findOrFail($id);
        $enrollment->credentials_verified = 0;
        $enrollment->save();

        session()->flash('success', 'Credentials verification revoked.');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.registrar-archive-manager', [
