    ...
    <x-layouts.student title="Student Dashboard">
        <div class="w-full">
            <div class="space-y-6">
                @if (session('success'))
                    <div
                        class="bg-[#10B981]/10 border border-[#10B981]/20 text-[#10B981] px-4 py-3 rounded-xl relative font-medium shadow-sm flex items-center gap-2">
                ...
                <div class="p-8 rounded-2xl border relative overflow-hidden group shadow-2xl shadow-black/40"
                    ...
                    <div
                        class="absolute top-0 right-0 p-12 opacity-5 mt-[-20px] mr-[-20px] transition-transform group-hover:scale-110 duration-700">
                        <svg class="w-64 h-64 text-[#10B981]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-6 relative z-10">
                        <div class="flex items-center gap-6">
                            <div
                                class="w-16 h-16 rounded-2xl bg-[#10B981]/10 border border-[#10B981]/20 flex items-center justify-center text-[#10B981] shadow-lg shadow-[#10B981]/10">
                            ...
                            <div>
                                <h2 class="text-3xl font-bold text-white leading-none tracking-tight">Welcome,
                                    {{ Auth::user()->first_name }}!</h2>
                                <p class="text-xs mt-2 font-medium uppercase tracking-[0.2em]"
                                    style="color: rgba(255,255,255,0.4);">Portal Access — Core Infrastructure</p>
                            </div>
                        </div>
                ...
                @elseif(!$activeSemester || !$activeYear)
                    <div class="p-6 rounded-2xl border flex items-center gap-4"
                        ...
                        <div>
                            ...
                            <p class="text-white/40 text-xs italic">Please wait for the next enrollment period announcement
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    @if ($canEnroll && !$isEnrolledInActiveYear)
                        <div class="group block h-full">
                            <div class="p-8 rounded-2xl border h-full transition-all duration-500 hover:scale-[1.02] relative overflow-hidden"
                                ...
                                <div class="flex justify-between items-start mb-6">
                                    <div>
                                        <h4 class="text-xs font-bold text-blue-400/80 uppercase tracking-[0.2em] mb-1">
                                            Enrollment</h4>
                                ...
                                <p class="text-xs text-white/40 leading-relaxed mb-6">Start a new enrollment or track your
                    ...
                    @else
                        <div class="p-8 rounded-2xl border h-full opacity-60 relative overflow-hidden"
                            ...
                            <div class="flex justify-between items-start mb-6">
                                <div>
                                    <h4 class="text-xs font-bold text-white/20 uppercase tracking-[0.2em] mb-1">Enrollment
                                    </h4>
                    ...
                    <div class="group block h-full">
                        <div class="p-8 rounded-2xl border h-full transition-all duration-500 hover:scale-[1.02] relative overflow-hidden"
                            ...
                            <div class="flex justify-between items-start mb-6">
                                <div>
                                    <h4 class="text-xs font-bold text-purple-400/80 uppercase tracking-[0.2em] mb-1">
                                        Payments</h4>
                                    <div class="text-2xl font-black text-white tracking-tight">Payments</div>
                                </div>
                                <div
                                    class="p-3 rounded-xl bg-purple-500/10 text-purple-400 group-hover:rotate-12 transition-transform shadow-lg shadow-purple-500/10">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="text-xs text-white/40 leading-relaxed mb-6">View outstanding balances and record
                    ...
                    <div class="group block h-full">
                        <div class="p-8 rounded-2xl border h-full transition-all duration-500 hover:scale-[1.02] relative overflow-hidden"
                            ...
                            <div class="flex justify-between items-start mb-6">
                                <div>
                                    <h4 class="text-xs font-bold text-amber-400/80 uppercase tracking-[0.2em] mb-1">My
                                        Account</h4>
                            ...
                            <p class="text-xs text-white/40 leading-relaxed mb-6">Maintain your contact information and
                ...
                <div class="p-8 rounded-2xl border shadow-2xl shadow-black/40 overflow-hidden relative"
                    ...
                    <div class="relative z-10 flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-bold text-white/20 uppercase tracking-widest italic mt-1">Application
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 relative z-10">
                        <div class="p-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 space-y-4">
                            <h4
                                class="text-xs font-black text-emerald-400 uppercase tracking-[0.2em] flex items-center gap-2">
                    ...
                    <div class="relative z-10">
                        @if ($canEnroll && !$isEnrolledInActiveYear)
                            <a href="{{ route('student.enrollment.create') }}"
                                class="inline-block bg-[#10B981] hover:bg-[#34d399] text-black font-black py-4 px-10 rounded-xl shadow-xl shadow-emerald-500/20 transition-all active:scale-95 uppercase tracking-widest text-xs">Apply
                                Now</a>
                        @else
                            <button disabled
                                class="inline-block bg-white/5 text-white/20 border border-white/10 font-bold py-4 px-10 rounded-xl cursor-not-allowed uppercase tracking-widest text-xs italic">Application
    ...
    <div class="w-full">
        <div class="space-y-6 animate-in fade-in duration-700" wire:poll.3s>
            ...
            <div class="p-8 rounded-2xl border relative overflow-hidden group shadow-2xl shadow-black/40"
                ...
                <div
                    class="absolute top-0 right-0 p-12 opacity-5 mt-[-20px] mr-[-20px] transition-transform group-hover:scale-110 duration-700">
                    <svg class="w-64 h-64 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                ...
                <div class="flex justify-between items-center relative z-10">
                    <div class="flex items-center gap-6">
                        <div
                            class="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shadow-lg shadow-emerald-500/10">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            <h2 class="text-3xl font-bold text-white leading-none tracking-tight">Financial Overview
                            </h2>
                            <p class="text-xs mt-2 font-medium uppercase tracking-[0.2em]"
                                style="color: rgba(255,255,255,0.4);">Daily Revenue & Collection Metrics</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="p-8 rounded-2xl border group transition-all duration-500 hover:scale-[1.02]"
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <h4 class="text-xs font-bold text-emerald-400/80 uppercase tracking-[0.2em] mb-1">Collected
                                Today</h4>
                            <div
                        ...
                        <div
                            class="p-3 rounded-xl bg-emerald-500/10 text-emerald-400 group-hover:rotate-12 transition-transform shadow-lg shadow-emerald-500/10">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                    ...
                    <div class="w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
                        <div class="bg-emerald-500 h-full w-[65%] group-hover:w-full transition-all duration-1000">
                        </div>
                    </div>
                    <p class="text-xs mt-4 font-bold text-white/20 uppercase tracking-widest italic">Confirmed Revenue
                    </p>
                </div>
                ...
                <div class="p-8 rounded-2xl border group transition-all duration-500 hover:scale-[1.02]"
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <h4 class="text-xs font-bold text-blue-400/80 uppercase tracking-[0.2em] mb-1">Receipts
                                Today
                            </h4>
                            <div
                                class="text-3xl font-black text-white tracking-tighter transition-transform group-hover:translate-x-1 duration-500">
            ...
            <div class="p-6 rounded-2xl border shadow-2xl shadow-black/40 overflow-hidden"
                ...
                <div class="flex items-center gap-3 mb-6 px-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-bold text-white/20 uppercase tracking-widest">
                            {{ now()->format('M d, Y') }}
                        ...
                        <tbody class="divide-y divide-white/5">
                            @forelse($paymentsToday as $payment)
                                <tr class="hover:bg-white/[0.02] transition-colors group">
                                    <td
                                        class="py-5 px-6 font-mono text-xs text-white/30 italic group-hover:text-emerald-400 transition-colors">
                                        #{{ str_pad($payment->id, 6, '0', STR_PAD_LEFT) }}</td>
                                    <td class="py-5 px-6 font-bold text-white uppercase tracking-tight">
                                        {{ optional($payment->user)->name }}</td>
                                    <td class="py-5 px-6 text-xs text-white/40">
                                        {{ $payment->updated_at->format('H:i A') }}</td>
                                    <td class="py-5 px-6 text-right font-black text-emerald-400">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-24 text-center">
                                        <p
                                            class="text-xs font-black text-white/10 uppercase tracking-[0.4em] italic leading-loose">
                                            No activity detected for today.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="p-6 rounded-2xl border shadow-2xl shadow-black/40 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700"
                ...
                <div class="flex items-center gap-3 mb-6 px-4">
                    ...
                    <h3 class="font-bold text-white/40 text-xs uppercase tracking-widest">Archived Records:
                        {{ now()->subDay()->format('M d, Y') }}</h3>
                </div>
                @if ($paymentsYesterday->isEmpty())
                    <div class="py-8 text-center text-xs font-bold text-white/5 uppercase tracking-widest italic">No
    ...
    @elseif($role === 'registrar')
        <x-layouts.registrar title="Registrar Dashboard">
            <div class="w-full space-y-6 animate-in fade-in duration-500">
                @if (session('success'))
                    <div
                        class="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-6 py-4 rounded-xl shadow-lg backdrop-blur-md flex items-center gap-3 mb-6 font-bold animate-in fade-in duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs mt-1 text-white/50 italic uppercase tracking-widest font-bold">Registry &
                                    Operations Summary</p>
                            </div>
                        </div>
                        <div class="px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest"
                        ...
                        @foreach ($weekDates as $day)
                            <div class="rounded-xl flex flex-col h-[380px]"
                                ...
                                <div class="text-center py-3 rounded-t-xl"
                                    style="{{ $day['is_today'] ? 'border-bottom: 1px solid rgba(99,179,237,0.3); background: rgba(99,179,237,0.12);' : 'border-bottom: 1px solid rgba(255,255,255,0.07);' }}">
                                    ...
                                    @if ($day['is_today'])
                                        <span
                                            class="inline-block mt-1 px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-tighter bg-blue-400 text-black">Today</span>
                                    @endif
                                </div>
                                <div class="p-2.5 flex-1 overflow-y-auto space-y-2 custom-scrollbar">
                                    ...
                                    @if ($dayApps->isEmpty())
                                        <div
                                            class="h-full flex items-center justify-center text-[8px] uppercase tracking-[0.2em] font-black text-white/10 italic">
                                            No Data</div>
                                    @else
                                        @foreach ($dayApps as $app)
                                            ...
                                            <a href="{{ route('registrar.dashboard', ['app_id' => $app['id']]) }}"
                                                class="p-2.5 rounded-lg border flex flex-col gap-1.5 transition-all hover:scale-105 active:scale-95 text-left w-full"
                                                style="background: {{ $style['bg'] }}; border-color: {{ $style['border'] }};">
                                                <p
                                                    class="text-[10px] font-bold text-white truncate uppercase tracking-tight">
                                                    {{ $app['first_name'] ?? '' }} {{ $app['last_name'] ?? '' }}</p>
                                                <div class="flex items-center gap-1.5">
                                                    <span class="w-1 h-1 rounded-full"
                                                        style="background: {{ $style['dot'] }};"></span>
                                                    <span class="text-[8px] font-black uppercase tracking-widest italic"
                                                        style="color: {{ $style['text'] }};">{{ $status === 'Enrolled' ? 'Paid' : $status }}</span>
                                                </div>
                                            </a>
                                        @endforeach
                                    @endif
                ...
                <div class="p-6 rounded-2xl border bg-white/5 backdrop-blur-md border-white/10 shadow-2xl">
                    <h3
                        class="font-black text-white mb-5 flex items-center gap-2 italic uppercase tracking-[0.2em] text-xs">
                        <span class="w-1 h-4 rounded-full bg-cyan-500"></span> Overview
                    </h3>
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        @foreach ($stats as $key => $val)
                            <div
                                class="p-4 rounded-xl border border-white/5 bg-white/[0.02] text-center shadow-inner group">
                                <div
                                    class="text-[8px] font-black uppercase tracking-[0.3em] mb-2 text-white/30 group-hover:text-cyan-400 transition-colors">
                ...
                @if ($selectedApp)
                    <a href="{{ route('registrar.dashboard') }}"
                        class="fixed inset-0 bg-[#060d1a]/85 backdrop-blur-sm z-[90] cursor-default transition-opacity duration-300"></a>
                    <div class="fixed inset-0 z-[100] p-4 flex items-center justify-center transition-all duration-500">
                        <div
                            class="rounded-[40px] shadow-2xl w-full max-w-5xl relative z-10 border overflow-hidden transform transition-all bg-[#0d1f3c] border-white/10 animate-in zoom-in-95 duration-500">

                            {{-- Modal Header --}}
                            <div class="px-10 py-8 border-b border-white/5 flex justify-between items-center bg-white/5">
                                <div class="flex items-center gap-6">
                                    <span
                                        class="bg-cyan-500/20 text-cyan-400 font-mono text-xs font-black px-4 py-2 rounded-xl border border-cyan-500/30 italic">#{{ str_pad($selectedApp->id, 2, '0', STR_PAD_LEFT) }}</span>
                                    <h3 class="text-2xl font-black text-white uppercase tracking-[0.15em]">Application
                                        Details</h3>
                                </div>
                                <a href="{{ route('registrar.dashboard') }}"
                                    class="text-white/20 hover:text-white transition p-3 rounded-2xl hover:bg-white/10">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="overflow-y-auto max-h-[80vh] custom-scrollbar">
                                <div class="p-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
                                    ...
                                    <div class="lg:col-span-4 space-y-6">
                                        <div
                                            class="p-8 rounded-[32px] bg-white/[0.02] border border-white/5 space-y-8 shadow-inner">
                                            <div class="space-y-4">
                                                <span
                                                    class="text-[10px] font-black text-cyan-400 uppercase tracking-[0.4em] block">Program
                                                    Choice</span>
                                                <h2
                                                    class="text-6xl font-black text-white tracking-tighter uppercase leading-none">
                                                    {{ $selectedApp->course_code }}</h2>
                                                <p
                                                    class="text-xs font-bold text-white/40 uppercase tracking-[0.2em] leading-relaxed">
                                                    {{ $selectedApp->year_level }}</p>
                                            </div>

                                            <div class="pt-8 border-t border-white/5 space-y-4">
                                                <span
                                                    class="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] block">Current
                                                    Status</span>
                                                @php
                                                ...
                                                @endphp
                                                <div
                                                    class="inline-block px-6 py-2 rounded-full border text-[10px] font-black tracking-[0.2em] {{ $statusClass }} shadow-lg">
                                                    {{ $statusLabel }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lg:col-span-8 space-y-12">
                                        ...
                                        <div class="space-y-6">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <h4
                                                    class="text-[10px] font-black text-cyan-400 uppercase tracking-[0.3em]">
                                                    Biographical Data</h4>
                                            </div>
                                            <div
                                                class="p-8 rounded-[32px] bg-white/[0.01] border border-white/5 grid grid-cols-2 gap-8">
                                                <div class="space-y-2">
                                                    <span
                                                        class="text-[8px] font-black text-white/20 uppercase tracking-widest block">Given
                                                        Name</span>
                                                    <span
                                                        class="text-2xl font-black text-white uppercase tracking-tight">{{ $selectedApp->first_name }}</span>
                                                </div>
                                                <div class="space-y-2">
                                                    <span
                                                        class="text-[8px] font-black text-white/20 uppercase tracking-widest block">Surname</span>
                                                    <span
                                                        class="text-2xl font-black text-white uppercase tracking-tight">{{ $selectedApp->last_name }}</span>
                                                </div>
                                                <div class="col-span-2 space-y-2">
                                                    <span
                                                        class="text-[8px] font-black text-white/20 uppercase tracking-widest block">Residential
                                                        Address</span>
                                                    <span
                                                        class="text-xs font-bold text-white/60 uppercase tracking-tight leading-relaxed">{{ $selectedApp->address_full ?? '— Not Provided —' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                @foreach ($docs as $label => $file)
                                                    <div class="space-y-3">
                                                        <div class="flex items-center gap-2 mb-1 pl-1">
                                                            <span
                                                                class="w-1.5 h-1.5 rounded-full {{ $file ? 'bg-emerald-500' : 'bg-rose-500' }}"></span>
                                                            <span
                                                                class="text-[8px] font-black text-white/30 uppercase tracking-widest">{{ $label }}</span>
                                                        </div>
                                                        <div
                                                            class="aspect-[3/4] rounded-2xl border bg-white/[0.02] border-white/5 flex flex-col items-center justify-center gap-3 group border-dashed relative overflow-hidden">
                                                            @if ($file)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="text-[8px] font-black text-white uppercase tracking-widest">View
                                                                        File</span>
                                                                </div>
                                                            @else
                                                                <svg class="w-8 h-8 text-white/5" fill="none"
                                                                ...
                                                                <span
                                                                    class="text-[8px] font-black text-white/10 uppercase tracking-[0.2em]">Missing</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        {{-- Promissory Note Asset (Registrar View) --}}
                                        @if ($selectedApp->promissory_note_path || $selectedApp->promissory_reason)
                                            <div class="space-y-6 pt-10 border-t border-white/5 lg:col-span-12">
                                                <div class="flex items-center gap-3">
                                                ...
                                                <div
                                                    class="grid grid-cols-1 lg:grid-cols-3 gap-8 bg-amber-500/5 border border-amber-500/10 rounded-[32px] p-8">
                                                    <div class="lg:col-span-1 space-y-4">
                                                        <span
                                                            class="text-[9px] font-black text-amber-500/40 uppercase tracking-widest italic">Note
                                                            Attachment</span>
                                                        @if ($selectedApp->promissory_note_path)
                                                            <a href="{{ \Storage::disk('public')->url($selectedApp->promissory_note_path) }}"
                                                                target="_blank"
                                                                class="flex items-center gap-4 p-5 rounded-2xl border border-amber-500/20 bg-amber-500/5 hover:bg-amber-500/10 transition-all">
                                                                <div
                                                                    class="w-11 h-11 rounded-xl bg-amber-500/20 flex items-center justify-center text-amber-400">
                                                        ...
                                                        @else
                                                            <div
                                                                class="p-5 rounded-2xl border border-dashed border-white/5 bg-white/[0.01] flex items-center justify-center opacity-30">
                                                                <span
                                                                    class="text-[8px] font-black text-white uppercase tracking-widest italic">No
                                                                    File Provided</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    <div class="lg:col-span-2 space-y-3">
                                                        <span
                                                            class="text-[9px] font-black text-amber-500/40 uppercase tracking-widest italic">Student's
                                                            Explanation</span>
                                                        <div
                                                            class="p-8 rounded-3xl bg-white/[0.02] border border-white/5 min-h-[100px]">
                                ...
                                <div
                                    class="bg-white/5 px-10 py-10 border-t border-white/5 flex justify-between items-center bg-[#070f1d]">
                                    <div class="flex flex-col gap-1 pl-2">
                                        <span
                                            class="text-[8px] font-black text-white/20 uppercase tracking-[0.3em]">Status:
                                            {{ strtoupper($selectedApp->status) }}</span>
                                        <span
                                            class="text-[10px] font-black text-white/40 uppercase tracking-widest italic decoration-emerald-500/30 underline decoration-2 underline-offset-8">Confirmed
                                            Submission</span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-4">
                                        @if (in_array(strtolower($selectedApp->status), ['pending', 'enrolled', 'paid']))
                                            <form action="{{ route('registrar.dashboard.reject', $selectedApp->id) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="bg-white/5 hover:bg-rose-500/10 text-white/30 hover:text-rose-500 px-8 py-4 rounded-[20px] text-[10px] font-black transition-all uppercase tracking-[0.2em] border border-white/5 hover:border-rose-500/20 active:scale-95">Deny
                                                    Entry</button>
                                            </form>
                                            <form action="{{ route('registrar.dashboard.approve', $selectedApp->id) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="bg-cyan-500 hover:bg-cyan-400 text-black px-12 py-4 rounded-[20px] text-[10px] font-black transition-all uppercase tracking-[0.2em] shadow-2xl shadow-cyan-500/40 active:scale-95 flex items-center gap-2">
                                        ...
                                        @endif
                                        <a href="{{ route('registrar.dashboard') }}"
                                            class="bg-white/5 hover:bg-white/10 text-white/40 hover:text-white px-10 py-4 rounded-[20px] text-[10px] font-black transition-all uppercase tracking-[0.2em] border border-white/5 italic">Close
                                            Panel</a>
                                    </div>
                                </div>
                            </div>
    ...
    @elseif($role === 'admin')
        <div class="w-full space-y-6">
            ...
            <div x-data="{ open: @entangle('showModal') }" x-show="open"
                ...
                {{-- Backdrop --}}
                <div class="absolute inset-0 bg-[#060d1a]/85 backdrop-blur-sm cursor-pointer" wire:click="closeModal">
                </div>
                                                        ...
                                                        <a href="{{ \Storage::disk('public')->url($selectedApp->promissory_note_path) }}"
                                                            ...
                                                            <div>
                                                                <p
                                                                    ...
                                                                    Download Note</p>
                                                                <p
                                                                    class="text-[8px] text-amber-500/60 uppercase font-bold mt-0.5">
