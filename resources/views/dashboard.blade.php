...
<x-layouts.registrar title="Registrar Dashboard">
    <div class="space-y-6 animate-in fade-in duration-500">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ route('registrar.payments.index') }}" class="p-5 rounded-2xl border bg-emerald-500/5 border-emerald-500/10 hover:bg-emerald-500/10 transition-all group flex items-center gap-4">
