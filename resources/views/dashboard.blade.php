            ...
            <div class="space-y-6">
                ...
                @if ($activeSemester && $activeYear && !$hasSubmitted)
                    <div class="p-8 rounded-[1.5rem] border flex items-center gap-6 {{ $hasSubmitted ? 'bg-slate-50' : 'bg-blue-50/50' }}"
                        ...
                        <div>
                            <h3
                                class="text-blue-900 font-black text-xl mb-1 {{ $hasSubmitted ? 'text-slate-400' : '' }}">
...
<div class="p-10 rounded-[2rem] border shadow-xl shadow-blue-900/5 overflow-hidden relative bg-white"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10 relative z-10">
        <div class="p-8 rounded-2xl border border-blue-100 bg-blue-50/30 space-y-6">
            <h4 class="text-xs font-black text-indigo-600 uppercase tracking-[0.2em] flex items-center gap-2">
            ...
            <div class="space-y-4 pt-6 border-t border-blue-100">
                ...
                <ul class="grid grid-cols-1 gap-3">
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        ...
                        <span class="text-xs text-slate-600 font-bold uppercase tracking-tight">SF9 (JHS Report
                            Card)</span>
                    </li>
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        <div
                        ...
                        <span class="text-xs text-slate-600 font-bold uppercase tracking-tight">SF10 (Permanent
                            Record)</span>
                    </li>
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        <div
                        ...
                        <span class="text-xs text-slate-600 font-bold uppercase tracking-tight">Certificate of Good
                            Moral</span>
                    </li>
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        <div
            ...
            <div class="space-y-4 pt-6 border-t border-blue-100">
                ...
                <ul class="grid grid-cols-1 gap-3">
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        ...
                        <span class="text-xs text-slate-600 font-bold uppercase tracking-tight">Form 137 (SHS Report
                            Card)</span>
                    </li>
                    <li class="flex items-center gap-3 p-2 rounded-lg bg-white border border-blue-50 shadow-sm">
                        <div
                    ...
                    <div class="rounded-3xl flex flex-col h-[400px] transition-all duration-500 hover:shadow-2xl hover:shadow-blue-900/10"
                        ...
                        <div class="text-center py-5 rounded-t-[1.4rem]"
                            ...
                            <p
                                ...
                                {{ $day['day_name'] }}</p>
                            <p
                                class="text-3xl font-black mt-1 {{ $day['is_today'] ? 'text-white' : 'text-slate-800' }}">
                                {{ $day['day_num'] }}</p>
                            @if ($day['is_today'])
                                <span
                            ...
                            @else
                                @foreach ($dayApps as $app)
                                    ...
                                    <a href="{{ route('registrar.dashboard', ['app_id' => $app['id']]) }}"
                                        ...
                                        <p
                                            class="text-[11px] font-black text-slate-800 truncate uppercase tracking-tight">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 mt-1">
                                            ...
                                            @php
                                                $isReturningApp = \App\Models\Enrollment::where(
                                                    'user_id',
                                                    $app['user_id'],
                                                )
                                                    ->where('id', '<', $app['id'])
                                                    ->exists();
                                                $appClass =
                                                    $app['student_type'] ?? ($isReturningApp ? 'Returning' : 'New');
        ...
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-[10px] font-black text-emerald-600 uppercase tracking-[0.3em]">✓ Regular Students
                    </p>
                    <p
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-[10px] font-black text-indigo-600 uppercase tracking-[0.3em]">Returning
                                Students</p>
                            <p
                ...
                <div class="p-8 rounded-[2rem] bg-blue-50 border border-blue-100 shadow-lg shadow-blue-600/5 group">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-4xl font-black text-slate-900 mt-2 tracking-tighter">{{ $shs_count }}
                            </h3>
                        </div>
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-6">Total SHS Applicants
                    </p>
                </div>
                <div
                    class="p-8 rounded-[2rem] bg-indigo-50 border border-indigo-100 shadow-lg shadow-indigo-600/5 group">
                    <div class="flex justify-between items-start">
                        <div>
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-6">Total College
                        Applicants</p>
                </div>
                <div
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-4xl font-black text-slate-900 mt-2 tracking-tighter">{{ $total_count }}
                            </h3>
                        </div>
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-6">Overall Applications
                    </p>
                </div>
            </div>
            ...
            <div class="p-10 rounded-[2rem] border bg-white shadow-xl shadow-blue-900/5 border-blue-100">
                <div class="flex items-center gap-4 mb-10 px-2">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.25em] mt-1">Real-time
                    ...
                    <div class="overflow-y-auto max-h-[85vh] custom-scrollbar">
                        <div class="p-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div class="lg:col-span-8 space-y-16">
                                ...
                                <div class="space-y-8">
                                    <div class="flex items-center gap-4">
                                        <div class="w-1.5 h-6 bg-blue-600 rounded-full shadow-lg shadow-blue-600/30">
                                        </div>
                                ...
                                @if ($selectedApp->promissory_note_path || $selectedApp->promissory_reason)
                                    <div class="space-y-8 pt-12 border-t border-slate-100 lg:col-span-12">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-1.5 h-6 bg-amber-400 rounded-full shadow-lg shadow-amber-400/30">
                                            </div>
                                            <h4 class="text-xs font-black text-slate-800 uppercase tracking-[0.3em]">
                                                    ...
                                                    <a href="{{ Storage::url($selectedApp->promissory_note_path) }}"
                                                        ...
                                                        <div>
                                                            <p
                                                                ...
                                                                View Note</p>
                                                            <p
                                                                class="text-[9px] font-bold text-amber-600 uppercase mt-1">
                                                                Official Document</p>
                                                        </div>
                                                    </a>
                                                @else
