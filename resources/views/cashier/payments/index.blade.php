<div class="max-w-7xl mx-auto py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <button wire:click="openModal" class="bg-[#10B981] hover:bg-[#059669] text-white text-xs font-bold py-2.5 px-5 rounded-lg shadow-md shadow-[#10B981]/10 uppercase tracking-wide transition flex items-center gap-2">
        ...
        <div class="bg-white px-6 py-4 border-b border-gray-100">
            <div class="flex flex-col sm:flex-row gap-3">
                <div class="relative flex-grow">
                    ...
                    <input type="text" wire:model.live="search" class="pl-10 w-full bg-white border border-gray-300 rounded-lg p-2 text-sm text-gray-900 focus:ring-2 focus:ring-[#10B981] outline-none transition-all placeholder-gray-400 shadow-sm" placeholder="Search student name, email, or receipt #...">
                </div>
                    ...
                    <tr class="hover:bg-gray-50 transition group">
                        ...
                        <td class="py-4 px-6 text-right relative" x-data="{ open: false }">
                            <div class="relative inline-block text-left">
                                ...
                                <div x-show="open" x-transition class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white border border-gray-200 ring-1 ring-black ring-opacity-5 z-50" style="display: none;">
                                    <div class="py-1">
                                        ...
                                        @if($payment->status !== 'Paid')
                                            <button wire:click="markAsPaid({{ $payment->id }})" class="w-full text-left block px-4 py-2 text-xs text-gray-700 font-semibold hover:bg-gray-50">
                                                <span class="flex items-center gap-2">
        ...
        <div class="fixed inset-0 z-50 p-4 modal-backdrop flex items-center justify-center">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md transform transition-all duration-200 border border-gray-200 relative z-10">
                <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white rounded-t-xl">
                    <h3 class="text-lg font-bold text-gray-900">{{ $paymentId ? 'Edit Payment Details' : 'Process New Payment' }}</h3>
