        ...
        <div class="bg-[#1C1C1E] rounded-xl shadow-md border border-[#27272A] overflow-hidden">
            ...
            <div class="bg-[#121212]/50 px-6 py-4 border-b border-[#27272A]">
                <form action="{{ route('cashier.payments.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('cashier.payments.index') }}" class="bg-[#27272A] border border-[#3F3F46] text-[#A1A1AA] hover:text-white hover:bg-[#3F3F46] text-sm font-medium px-4 py-2 rounded-lg transition text-center">Reset</a>
                </form>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-[#27272A]">
                        ...
                        <tr class="hover:bg-[#27272A]/30 transition group">
                            ...
                            <td class="py-4 px-6 text-[#A1A1AA]">@if(optional($payment->application)->course_code)<span class="font-bold text-[#10B981]">{{ $payment->application->course_code }}</span><span class="text-xs text-[#52525B] block">{{ $payment->application->year_level }}</span>@else<span class="text-[#3F3F46] italic text-xs">N/A</span>@endif</td>
        ...
        <div class="bg-[#1C1C1E] rounded-xl shadow-2xl w-full max-w-md transform scale-95 transition-transform duration-200 border border-[#27272A]" id="modalContent">
            ...
            <form id="paymentForm" action="{{ route('cashier.payments.store') }}" method="POST" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <select name="user_id" id="user_id" class="w-full bg-[#121212] border border-[#27272A] text-[#FFFFFF] rounded-lg p-3 text-sm focus:ring-2 focus:ring-[#10B981] focus:border-[#10B981] outline-none transition-all appearance-none cursor-pointer" required>
