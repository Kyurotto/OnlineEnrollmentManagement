...
<body class="bg-gray-50 text-gray-600 pb-12">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-20">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('student.dashboard') }}" class="text-sm text-gray-500 hover:text-[#10B981] transition font-medium">← Back to Dashboard</a>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    <div>
                        ...
                        <select name="year_level" class="autosave w-full bg-white text-gray-900 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                    ...
                    <div>
                        ...
                        <select name="semester" class="autosave w-full bg-white text-gray-900 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                    ...
                    <div>
                        ...
                        <select name="academic_year" class="autosave w-full bg-white text-gray-900 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                            <option value="">Select Year</option>
