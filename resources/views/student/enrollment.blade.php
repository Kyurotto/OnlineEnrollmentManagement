...
<body class="bg-gray-50 text-gray-700 pb-12">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-20">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('student.dashboard') }}" class="text-sm text-gray-600 hover:text-[#10B981] transition">← Back to Dashboard</a>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="enrollment-form" action="{{ route('student.enrollment.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="border border-gray-300 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded transition-colors">
                        <input type="radio" name="course_code" value="ACT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-700"><span class="font-bold text-gray-900">ACT</span> — ASSOCIATE IN COMPUTER TECH</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded transition-colors">
                        <input type="radio" name="course_code" value="BSIS" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-700"><span class="font-bold text-gray-900">BSIS</span> — BS INFORMATION SYSTEMS</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded transition-colors">
                        <input type="radio" name="course_code" value="BTVTED" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-700"><span class="font-bold text-gray-900">BTVTED</span> — BTV Teacher Education</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded transition-colors">
                        <input type="radio" name="course_code" value="DHRT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-700"><span class="font-bold text-gray-900">DHRT</span> — HOTEL & RESTAURANT TECH</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded transition-colors">
                        <input type="radio" name="course_code" value="DIT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-700"><span class="font-bold text-gray-900">DIT</span> — DIPLOMA INFO TECH</span>
                    </label>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Year Level</label>
                        <select name="year_level" class="autosave w-full bg-white text-gray-900 border-gray-300 rounded-md shadow-sm border py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                    ...
                    <div>
                        ...
                        <select name="semester" class="autosave w-full bg-white text-gray-900 border-gray-300 rounded-md shadow-sm border py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                    ...
                    <div>
                        ...
                        <select name="academic_year" class="autosave w-full bg-white text-gray-900 border-gray-300 rounded-md shadow-sm border py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
                            <option value="">Select Year</option>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <input type="text" name="last_name" placeholder="Last Name"
                        ...
                        class="autosave bg-transparent border-b border-gray-300 py-2 w-full focus:border-[#10B981] outline-none text-gray-900 placeholder-gray-400" required>
                    ...
                    <input type="text" name="middle_name" placeholder="Middle Name"
                        ...
                        class="autosave bg-transparent border-b border-gray-300 py-2 w-full focus:border-[#10B981] outline-none text-gray-900 placeholder-gray-400">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="gender" value="male" class="autosave text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300 mr-2">
                            <span class="text-gray-700">Male</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="gender" value="female" class="autosave text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300 mr-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <input type="email" name="email"
                        ...
                        readonly
                        class="border-b border-gray-200 py-2 w-full focus:border-[#10B981] outline-none text-gray-500 cursor-not-allowed bg-gray-50" required>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex space-x-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="ip_community" value="yes" class="autosave text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300 mr-2">
                            <span class="text-gray-700">Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="ip_community" value="no" class="autosave text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300 mr-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-5 rounded-xl border border-gray-200">
                        ...
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors group">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                ...
                                <p class="mb-2 text-sm text-gray-600 leading-tight"><span class="font-semibold text-[#10B981]">Tap to upload</span> or take a photo</p>
                                <p class="text-xs text-gray-400 truncate max-w-[200px]" id="file-name-137">PNG, JPG or PDF</p>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 rounded-xl border border-gray-200">
                        ...
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors group">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                <svg class="w-8 h-8 mb-3 text-[#10B981] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5"></path></svg>
                                <p class="mb-2 text-sm text-gray-600 leading-tight"><span class="font-semibold text-[#10B981]">Tap to upload</span> or take a photo</p>
                                <p class="text-xs text-gray-400 truncate max-w-[200px]" id="file-name-moral">PNG, JPG or PDF</p>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 rounded-xl border border-gray-200">
                        ...
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors group">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                <svg class="w-8 h-8 mb-3 text-[#10B981] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5"></path></svg>
                                <p class="mb-2 text-sm text-gray-600 leading-tight"><span class="font-semibold text-[#10B981]">Tap to upload</span> or take a photo</p>
                                <p class="text-xs text-gray-400 truncate max-w-[200px]" id="file-name-psa">PNG, JPG or PDF</p>
                            </div>
                    ...
                    <div class="bg-[#10B981]/5 p-5 rounded-xl border border-[#10B981]/20">
                        <div class="mb-3">
                            ...
                            <p class="text-xs text-gray-500">White background, formal attire.</p>
                        </div>
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-[#10B981]/40 border-dashed rounded-lg cursor-pointer bg-white hover:bg-[#10B981]/10 transition-colors group">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                <svg class="w-8 h-8 mb-3 text-[#10B981] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5"></path></svg>
                                <p class="mb-2 text-sm text-gray-600 leading-tight"><span class="font-semibold text-[#10B981]">Take a Selfie</span> or upload photo</p>
                                <p class="text-xs text-gray-400 truncate max-w-[200px]" id="file-name-pic">PNG or JPG only</p>
                            </div>
            ...
            <div class="flex justify-end">
                @if ($errors->any())
                <div class="mb-6 bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded shadow-sm w-full" role="alert">
    ...
    function updateFileName(input, textId) {
        ...
        if (input.files && input.files.length > 0) {
            textElement.classList.remove('text-gray-400', 'text-gray-500');
            textElement.classList.add('text-gray-900', 'font-bold');
            textElement.innerText = input.files[0].name;
        } else {
            textElement.classList.add('text-gray-400');
            textElement.classList.remove('text-gray-900', 'font-bold');
