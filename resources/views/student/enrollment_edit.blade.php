...
<div class="space-y-6">
    ...
    <div class="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-700">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-3xl font-black text-slate-900 tracking-tight uppercase">Edit Enrollment Application</h2>
                <p class="text-[10px] mt-2 font-black uppercase tracking-[0.3em] text-blue-600/50">Modify Your Submission</p>
            </div>
