...
<body class="bg-gray-50 text-gray-600 flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-3">
                    <div class="bg-[#10B981] text-white font-bold p-2 rounded-lg text-sm shadow-sm">RD</div>
                        <div>
    ...
    <div id="semesterModal" class="fixed inset-0 bg-black/40 hidden z-50 flex items-center justify-center backdrop-blur-sm">
        <div class="bg-white rounded-lg shadow-2xl w-full max-w-lg p-6 transform transition-all border border-gray-200">
            <h3 class="text-lg font-bold text-gray-900 mb-4" id="modalTitle">Add New Semester</h3>
            ...
            <form id="semesterForm" action="{{ route('registrar.semesters.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <select name="academic_year" id="academic_year" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none shadow-sm" required>
                    ...
                    <div>
                        ...
                        <select name="name" id="name" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="start_date" id="start_date" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none shadow-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">End Date</label>
                        <input type="date" name="end_date" id="end_date" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none shadow-sm" required>
                    </div>
                </div>
                ...
                <div class="mb-6 flex items-center">
                    ...
                    <label for="is_active" class="ml-2 text-sm text-gray-600 font-medium">Set as Active Semester</label>
                </div>

                <div class="flex justify-end gap-2">
                    <button type="button" onclick="closeModal()" class="px-4 py-2 text-sm text-gray-700 border border-gray-300 hover:bg-gray-50 rounded transition font-medium shadow-sm">Cancel</button>
