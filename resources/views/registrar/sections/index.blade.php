...
<body class="bg-[#121212] text-[#A1A1AA]">
            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-[#52525B]">Manage Sections</span>
                    </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-[#1C1C1E] rounded-lg shadow-sm border border-[#27272A] p-6">
            <div class="mb-6">
                <h2 class="text-xl font-bold text-white mb-4">Sections List</h2>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        ...
                        <tr class="border-b border-[#27272A] hover:bg-[#27272A]/50 transition group">
                            <td class="py-4 px-4 text-[#52525B]">{{ $section->id }}</td>
                            <td class="py-4 px-4 font-medium text-[#A1A1AA]">{{ $section->academic_year }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="py-6 text-center text-[#52525B] text-sm">No sections found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div id="sectionModal" class="fixed inset-0 bg-black/60 hidden z-50 flex items-center justify-center backdrop-blur-sm">
        <div class="bg-[#1C1C1E] rounded-lg shadow-xl w-full max-w-md p-6 transform transition-all border border-[#27272A]">
            <h3 class="text-lg font-bold text-white mb-4" id="modalTitle">Add New Section</h3>
            ...
            <form id="sectionForm" action="{{ route('registrar.sections.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-xs font-bold text-[#A1A1AA] uppercase mb-1">Program</label>
                    <select name="course_id" id="course_id" class="w-full bg-[#121212] border border-[#27272A] text-white rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none" required>
                ...
                <div class="mb-6">
                    <label class="block text-xs font-bold text-[#A1A1AA] uppercase mb-1">Section Name</label>
                    <input type="text" name="section_name" id="section_name" class="w-full bg-[#121212] border border-[#27272A] text-white rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none uppercase placeholder-[#52525B]" placeholder="e.g. BSIS 1A" required>
                    <p class="text-[10px] text-[#52525B] mt-1">Enter the full section name (e.g., BSIS 1A).</p>
                </div>
