...
<body class="bg-gray-50 text-gray-600 flex flex-col min-h-screen">
    ...
    <div id="sectionModal" class="fixed inset-0 bg-black/40 hidden z-50 flex items-center justify-center backdrop-blur-sm">
        <div class="bg-white rounded-lg shadow-2xl w-full max-w-md p-6 transform transition-all border border-gray-200">
            ...
            <form id="sectionForm" action="{{ route('registrar.sections.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="course_id" id="course_id" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none shadow-sm" required>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="section_name" id="section_name" class="w-full bg-white border border-gray-300 text-gray-900 rounded p-2 text-sm focus:ring-2 focus:ring-[#10B981] outline-none uppercase placeholder-gray-400 shadow-sm" placeholder="e.g. BSIS 1A" required>
                    <p class="text-[10px] text-gray-500 mt-1">Enter the full section name (e.g., BSIS 1A).</p>
                </div>

                <div class="flex justify-end gap-2">
                    <button type="button" onclick="closeModal()" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 border border-gray-300 rounded transition shadow-sm font-medium">Cancel</button>
