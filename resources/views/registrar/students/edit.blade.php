...
<body class="bg-gray-50 text-gray-600 flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-6">
                    <div class="relative">
                        <svg class="w-6 h-6 text-gray-500 hover:text-[#10B981] transition cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="min-h-screen flex items-center justify-center p-6 -mt-10">
        <div class="max-w-3xl w-full bg-white p-10 rounded-xl shadow-md border border-gray-200">
            ...
            <form action="{{ route('registrar.students.update', $student->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name', $student->first_name) }}" class="w-full bg-white text-gray-900 border border-gray-300 rounded p-3 text-sm focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] outline-none uppercase placeholder-gray-400 shadow-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Middle Name</label>
                        <input type="text" name="middle_name" value="{{ old('middle_name', $student->middle_name) }}" class="w-full bg-white text-gray-900 border border-gray-300 rounded p-3 text-sm focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] outline-none uppercase placeholder-gray-400 shadow-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Last Name</label>
                        <input type="text" name="last_name" value="{{ old('last_name', $student->last_name) }}" class="w-full bg-white text-gray-900 border border-gray-300 rounded p-3 text-sm focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] outline-none uppercase placeholder-gray-400 shadow-sm">
                    </div>
                </div>
                <div class="mb-6">
                    <label class="block text-xs font-bold text-gray-700 mb-1">Email Address</label>
                    <input type="email" name="email" value="{{ old('email', $student->email) }}" class="w-full bg-white text-gray-900 border border-gray-300 rounded p-3 text-sm focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] outline-none placeholder-gray-400 shadow-sm">
                </div>

                <div class="mb-6">
                    <label class="block text-xs font-bold text-gray-700 mb-1">Status</label>
                    <select name="status" class="w-full bg-white text-gray-900 border border-gray-300 rounded p-3 text-sm focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] outline-none shadow-sm cursor-pointer">
                ...
                <div class="flex justify-end gap-4 mt-8">
                    <a href="{{ route('registrar.students.index') }}" class="px-6 py-2.5 border border-gray-300 bg-white shadow-sm rounded text-gray-700 font-medium hover:bg-gray-50 transition text-sm">Cancel</a>
