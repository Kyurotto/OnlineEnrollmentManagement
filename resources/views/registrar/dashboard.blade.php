...
<body class="bg-[#121212] text-[#A1A1AA] flex flex-col min-h-screen">
                                    ...
                                    <div data-application="{{ json_encode($notif) }}"
                                        ...
                                        @if ($notif->status === 'Enrolled')
                                            ...
                                            <p class="text-xs text-[#A1A1AA] mt-1">
                                                <span
                                                    class="font-medium text-[#FFFFFF]">{{ $notif->first_name ?? ($notif->user->first_name ?? '') }}
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full space-y-6">
        ...
        <div class="bg-[#1C1C1E] p-8 rounded-xl shadow-md border border-[#27272A]">
            ...
            <p class="text-[#A1A1AA] mb-2">Manage academic records and configuration.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                @foreach ($weekDates as $day)
                    <div
                        class="border {{ $day['is_today'] ? 'border-[#10B981] bg-[#10B981]/10' : 'border-[#27272A] bg-[#121212]/50' }} rounded-xl flex flex-col h-[400px]">

                        <div
                            class="text-center py-4 border-b {{ $day['is_today'] ? 'border-[#10B981]/30 bg-[#10B981]/20 rounded-t-xl' : 'border-[#27272A]' }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('registrar.students.index') }}" class="block">
                <div
                    class="bg-[#1C1C1E] p-6 rounded-xl shadow-md border border-[#27272A] hover:shadow-lg transition cursor-pointer flex justify-between items-start group h-full hover:border-[#10B981]">
                    <div>
            ...
            <a href="{{ route('registrar.academic-years.index') }}" class="block">
                <div
                    class="bg-[#1C1C1E] p-6 rounded-xl shadow-md border border-[#27272A] hover:shadow-lg transition cursor-pointer flex justify-between items-start group h-full hover:border-[#10B981]">
                    <div>
                        <h3 class="font-bold text-lg text-[#FFFFFF] group-hover:text-[#10B981] transition">Academic
                            Years</h3>
    ...
    <div id="applicationModal"
        ...
        <div
            class="relative mx-auto p-0 border border-[#27272A] w-full max-w-2xl shadow-2xl rounded-lg bg-[#1C1C1E] transform transition-all">
            <div
                class="flex justify-between items-center px-6 py-4 border-b border-[#27272A] bg-[#121212] rounded-t-lg">
            ...
            <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                <div class="space-y-4">
                    <h4
                        class="text-xs font-bold text-[#A1A1AA] uppercase tracking-wider border-b border-[#27272A] pb-2">
                        Student Information</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div><span class="block text-[#A1A1AA] text-xs">Full Name</span><span
                                class="font-bold text-[#FFFFFF] uppercase" id="modalName"></span></div>
                        <div><span class="block text-[#A1A1AA] text-xs">Email</span><span
                                class="font-medium text-[#FFFFFF]" id="modalEmail"></span></div>
                        <div><span class="block text-[#A1A1AA] text-xs">Course</span><span
                                class="font-bold text-[#10B981]" id="modalCourse"></span></div>
                        <div><span class="block text-[#A1A1AA] text-xs">Year</span><span
                                class="font-medium text-[#FFFFFF]" id="modalYear"></span></div>
                        <div class="col-span-2"><span class="block text-[#A1A1AA] text-xs">Status</span><span
                                id="modalStatus" class="font-bold text-[#FFFFFF]"></span></div>
                    </div>
                </div>
            </div>
