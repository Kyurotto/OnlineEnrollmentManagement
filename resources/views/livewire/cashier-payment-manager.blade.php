            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="flex items-center gap-3">
                        <h3 class="font-black text-white text-xl leading-none uppercase tracking-tight">
                            {{ $level ? strtoupper($level) : '' }} Payments Management
                        </h3>
                        @if($level)
                            <span class="px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest {{ $level === 'shs' ? 'bg-amber-500/10 text-amber-500 border-amber-500/20' : 'bg-blue-500/10 text-blue-500 border-blue-500/20' }} border">
                                {{ $level === 'shs' ? 'Senior High' : 'College' }}
                            </span>
                        @endif
                    </div>
                    <p class="text-xs text-white/30 font-bold uppercase tracking-widest mt-2">
            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <div class="w-full sm:w-48 relative">
                        <select wire:model.live="filterCourse" class="w-full bg-white/5 bg-none border border-white/10 rounded-xl py-3 px-5 text-xs text-white/60 font-black uppercase tracking-widest focus:border-emerald-500/50 outline-none cursor-pointer appearance-none transition-all shadow-inner">
