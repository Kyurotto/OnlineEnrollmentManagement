<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
        <div wire:loading wire:target="openCreateModal, search, filter_course, status, resetFilters" class="absolute inset-0 bg-white/50 z-10 flex items-center justify-center backdrop-blur-sm">
        ...
        <div class="px-6 py-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white">
            ...
            <button wire:click="openCreateModal" class="bg-[#10B981] hover:bg-[#059669] text-white text-sm font-bold px-5 py-2 rounded-lg shadow-md shadow-[#10B981]/10 uppercase tracking-wide transition flex items-center gap-2">
    ...
    @if($showModal)
    <div class="fixed inset-0 z-50 p-4 modal-backdrop flex items-center justify-center transition-opacity duration-200">
        <div class="absolute inset-0" wire:click="closeModal"></div>

        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md relative z-10 border border-gray-200 transform transition-all duration-200">
            ...
            <form wire:submit.prevent="savePayment" class="p-6 space-y-5 bg-white rounded-b-xl">
                <div>
                    ...
                    @error('payment_user_id') <span class="text-xs text-red-500 font-bold block pt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('payment_amount') <span class="text-xs text-red-500 font-bold block pt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('payment_reference_no') <span class="text-xs text-red-500 font-bold block pt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="pt-4 flex justify-end gap-3 border-t border-gray-100 mt-6 pt-5">
                    ...
                    <button type="submit" class="px-6 py-2.5 text-sm bg-[#10B981] hover:bg-[#059669] text-white font-bold rounded-lg shadow-md shadow-[#10B981]/10 transition-all uppercase tracking-wide">
                        <span wire:loading.remove wire:target="savePayment">{{ $isEditMode ? 'Update Payment' : 'Save Payment' }}</span>
