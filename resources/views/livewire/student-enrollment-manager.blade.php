        ...
        <form wire:submit="submitApplication" class="space-y-6">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="border border-gray-300 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 bg-gray-50">
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-100 rounded transition-colors">
                        <input type="radio" wire:model="course_code" name="course_code" value="ACT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-600"><span class="font-bold text-gray-900">ACT</span> — ASSOCIATE IN COMPUTER TECH</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-100 rounded transition-colors">
                        <input type="radio" wire:model="course_code" name="course_code" value="BSIS" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-600"><span class="font-bold text-gray-900">BSIS</span> — BS INFORMATION SYSTEMS</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-100 rounded transition-colors">
                        <input type="radio" wire:model="course_code" name="course_code" value="BTVTED" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-600"><span class="font-bold text-gray-900">BTVTED</span> — BTV Teacher Education</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-100 rounded transition-colors">
                        <input type="radio" wire:model="course_code" name="course_code" value="DHRT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                        <span class="text-sm text-gray-600"><span class="font-bold text-gray-900">DHRT</span> — HOTEL & RESTAURANT TECH</span>
                    </label>
                    <label class="flex items-start space-x-3 cursor-pointer p-2 hover:bg-gray-100 rounded transition-colors">
                        <input type="radio" wire:model="course_code" name="course_code" value="DIT" class="autosave mt-1 h-4 w-4 text-[#10B981] focus:ring-[#10B981] bg-white border-gray-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    <div>
                        ...
                        <select wire:model="year_level" name="year_level" class="autosave w-full bg-white text-gray-900 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-[#10B981] focus:border-[#10B981] outline-none">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <input type="text" wire:model="contact" name="contact" placeholder="Contact Number (e.g. 09123456789)"
                        maxlength="11"
                        pattern="[0-9]{11}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" wire:model="mother_maiden_name" name="mother_maiden_name" placeholder="Mother's Maiden Name"
                                class="autosave bg-transparent border-b border-gray-300 py-2 w-full focus:border-[#10B981] outline-none text-gray-900 placeholder-gray-400 font-medium">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1">Guardian Contact Number</label>
                            <input type="text" wire:model="guardian_contact" name="guardian_contact" placeholder="Contact Number (e.g. 09123456789)"
                                maxlength="11"
                                pattern="[0-9]{11}"
                                title="Please enter exactly 11 digits"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
            ...
            if (savedData[input.name]) {
                if (input.type === 'radio') {
                    if (input.value === savedData[input.name]) {
                        input.checked = true;
                        @this.set(input.name, savedData[input.name]);
                    }
                } else {
