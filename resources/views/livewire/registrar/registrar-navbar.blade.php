            ...
            <div class="flex items-center gap-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-gray-500">
                            ...
                            @elseif($currentRoute === 'registrar.programs.index') Manage Programs
                            @elseif($currentRoute === 'registrar.academic_years.index') Academic Years
                            @elseif($currentRoute === 'registrar.semesters.index') Manage Semesters
                            @elseif($currentRoute === 'registrar.sections.index') Manage Sections
                ...
                <div class="flex space-x-6 text-sm font-medium text-gray-600 h-16">
                    <a wire:navigate href="{{ route('registrar.dashboard') }}"
                        class="flex items-center hover:text-[#10B981] transition h-full {{ $currentRoute === 'registrar.dashboard' ? 'text-[#10B981] border-b-2 border-[#10B981]' : '' }}">Dashboard</a>
                </div>
            </div>
