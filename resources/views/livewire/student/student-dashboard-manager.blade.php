    ...
    <div class="space-y-6">
        ...
        <div class="p-6 rounded-2xl border flex items-center gap-4"
            ...
            <div class="ml-auto hidden sm:block">
                <a href="{{ route('student.enrollment.create') }}" wire:navigate class="bg-[#10B981] hover:bg-[#34d399] text-black text-xs font-black px-6 py-2.5 rounded-xl uppercase tracking-widest transition-all active:scale-95 shadow-lg shadow-emerald-500/20">Enroll Now</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('student.enrollment.create') }}" wire:navigate class="group block h-full">
            ...
            {{-- Payments Card --}}
            <a href="{{ route('student.payment') }}" wire:navigate class="group block h-full">
                <div class="p-8 rounded-2xl border h-full transition-all duration-500 hover:scale-[1.02] relative overflow-hidden"
            ...
            {{-- Profile Card --}}
            <a href="{{ route('student.profile') }}" wire:navigate class="group block h-full">
                <div class="p-8 rounded-2xl border h-full transition-all duration-500 hover:scale-[1.02] relative overflow-hidden"
        ...
        <div class="p-8 rounded-2xl border shadow-2xl shadow-black/40 overflow-hidden"
            ...
            @if($canEnroll && !$isEnrolledInActiveYear)
            <a href="{{ route('student.enrollment.create') }}" wire:navigate class="inline-block bg-[#10B981] hover:bg-[#34d399] text-black font-black py-4 px-10 rounded-xl shadow-xl shadow-emerald-500/20 transition-all active:scale-95 uppercase tracking-widest text-xs">Apply Now</a>
            @else
