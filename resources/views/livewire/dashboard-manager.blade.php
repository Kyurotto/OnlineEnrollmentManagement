<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <a wire:navigate href="{{ route('admin.courses.index') }}" class="block">
            <div
                ...
                <div>
                    <h3 class="font-bold text-lg text-gray-900 group-hover:text-[#10B981] transition">Manage Courses</h3>
        ...
        <a wire:navigate href="{{ route('admin.students.index') }}" class="block">
            <div
                class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-[#10B981] hover:shadow-md transition-all cursor-pointer flex justify-between items-start group h-full">
                <div>
        ...
        <a wire:navigate href="{{ route('admin.payments.index') }}" class="block">
            <div
                class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-[#10B981] hover:shadow-md transition-all cursor-pointer flex justify-between items-start group h-full">
                <div>
                    <h3 class="font-bold text-lg text-gray-900 group-hover:text-[#10B981] transition">Manage Payments</h3>
        ...
        <a wire:navigate href="{{ route('admin.applications.index') }}" class="block">
            <div
                class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-[#10B981] hover:shadow-md transition-all cursor-pointer flex justify-between items-start group h-full">
                <div>
