            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                ...
                <tbody class="text-sm divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-gray-50 transition group">
                        ...
                        <td class="py-4 px-6 text-right relative" x-data="{ open: false }" @click.away="open = false">
    ...
    <div x-data="{ open: false }" 
        ...
        <div x-show="open" 
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50 rounded-t-xl">
                ...
                <button type="button" @click="open = false" class="text-gray-400 hover:text-gray-600 transition focus:outline-none">
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="p-6 space-y-5">
                ...
                <div class="pt-4 flex justify-end gap-3">
                    <button type="button" @click="open = false" class="px-5 py-2.5 text-sm font-semibold text-gray-600 hover:text-gray-900 transition border border-transparent">Cancel</button>
