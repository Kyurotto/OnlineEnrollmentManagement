        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <form action="{{ route('admin.payments.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('admin.payments.index') }}" class="bg-white border border-gray-300 text-gray-700 hover:text-gray-900 hover:bg-gray-50 text-sm font-medium px-4 py-2 rounded-lg transition text-center shadow-sm">Reset</a>
                </form>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md transform scale-95 transition-transform duration-200 border border-gray-200" id="modalContent">
            ...
            <form id="paymentForm" action="{{ route('admin.payments.store') }}" method="POST" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <select name="user_id" id="user_id" class="w-full bg-white border border-gray-300 text-gray-900 rounded-lg p-3 text-sm focus:ring-2 focus:ring-[#10B981] focus:border-[#10B981] outline-none transition-all appearance-none shadow-sm" required>
                ...
                <div class="pt-4 flex justify-end gap-3">
                    <button type="button" onclick="closeModal()" class="px-5 py-2.5 text-sm font-semibold text-gray-600 hover:text-gray-900 transition border border-transparent">Cancel</button>
