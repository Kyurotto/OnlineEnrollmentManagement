    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="text-blue-400/60 text-xs font-bold uppercase tracking-widest mt-1">Catalog and academic
                    offerings</p>
            </div>

            @if (session('success'))
                <div
                    class="bg-blue-500/10 border border-blue-500/20 text-blue-400 px-4 py-3 rounded-xl relative mb-6 font-bold shadow-lg backdrop-blur-md flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 p-8 rounded-2xl border h-fit"
                    ...
                    <form action="{{ route('admin.courses.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2 px-1">Code</label>
                            ...
                            @error('course_code')
                                <span
                                    class="text-rose-500 text-[10px] font-bold uppercase tracking-widest mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2 px-1">Full
                                Name</label>
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2 px-1">Credits</label>
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2 px-1">Description</label>
                        ...
                        <button type="submit"
                            class="w-full bg-blue-500 hover:bg-blue-400 text-white font-black py-4 rounded-xl shadow-lg shadow-blue-500/20 transition-all uppercase tracking-widest text-xs">
                            Add to Catalog
                        </button>
                    </form>
                </div>
                    ...
                    <div class="overflow-x-auto flex-grow">
                        <table class="min-w-full divide-y divide-white/5">
                            <thead class="bg-white/5">
                                <tr>
                                    <th
                                        class="px-6 py-4 text-left text-[10px] font-black text-blue-300 uppercase tracking-widest">
                                        Code</th>
                                    <th
                                        class="px-6 py-4 text-left text-[10px] font-black text-blue-300 uppercase tracking-widest">
                                        Name</th>
                                    <th
                                        class="px-6 py-4 text-center text-[10px] font-black text-blue-300 uppercase tracking-widest">
                                        Units</th>
                                    <th
                                        class="px-6 py-4 text-center text-[10px] font-black text-blue-300 uppercase tracking-widest">
                                        Actions</th>
                                ...
                                @foreach ($courses as $course)
                                    <tr class="hover:bg-white/5 transition-all group">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="text-xs font-black text-blue-400 bg-blue-500/10 px-2 py-1 rounded border border-blue-500/20">
                                                {{ $course->course_code }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div
                                                class="text-sm font-bold text-white group-hover:text-blue-200 transition-colors uppercase">
                                                {{ $course->course_name }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-white/50 font-bold">
                                            {{ $course->credits }}</td>
